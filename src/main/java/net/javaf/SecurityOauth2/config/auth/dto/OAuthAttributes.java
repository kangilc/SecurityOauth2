...
import net.javaf.SecurityOauth2.domain.Role;
...
public class OAuthAttributes {
	...
	public static OAuthAttributes of(String registrationId, String userNameAttributeName,
		...
		}else if ("lmp".equals(registrationId)) {
			return ofLmp("id", attributes);
		}
	...
	private static OAuthAttributes ofLmp(String userNameAttributeName, Map<String, Object> attributes) {
